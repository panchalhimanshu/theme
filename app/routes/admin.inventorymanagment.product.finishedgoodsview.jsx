...
export default function Component() {
  return (
    <Layout>
      ...
      <div className="pb-2">
              <h1 className="font-bold text-lg">Finished Goods Detail </h1>
            </div>
        ...
        <div className="flex justify-end">
          <button 
            ...
            className=" dark:text-white font-semibold text-black px-4 py-2 rounded-full mr-2 shadow-md border border-black dark:border-white">
            Go Back
          </button>
          <button 
            // onClick={handleGoBack}
            className=" dark:text-white font-semibold text-black px-6 py-2 rounded-full shadow-md border border-black dark:border-white">
              <Link to={'/admin/inventorymanagment/product/finishedgoodsedit'}>
            Edit
            </Link>
          </button>
        </div>
