...
export default function Component() {
  ...
  return (
    ...
    <div className="mx-auto p-6 dark:bg-black bg-white dark:text-white text-black shadow-md rounded-lg">
      <h2 className="text-2xl font-bold mb-6">Edit Finished Goods</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4">
          <button
            type="button"
            className="px-4 py-2 border p-2 border border-border rounded-md text-sm font-medium dark:bg-black bg-black text-white dark:bg-white dark:text-black"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium bg-black text-white dark:bg-white dark:text-black"
          >
            Save
          </button>
        </div>
