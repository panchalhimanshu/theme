    ...
    return (
        <>
            ...
            <li className="px-4 py-2">
                <Link
                    to="/admin/settings"
                    className={`p-2 rounded-md flex items-center gap-2 ${isActive('/admin/settings') ? 'bg-black text-white dark:bg-white dark:text-black' : 'dark:hover:bg-white dark:hover:text-black hover:bg-black hover:text-white'}`}
                >
                    <Settings className="w-5 h-5" />
